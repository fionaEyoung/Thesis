...
\newacronym[prefixfirst={a~},prefix={an\space}]{rf}{RF}{radio frequency}
...
\newacronym[prefixfirst={a~},prefix={an\space}]{mprage}{MPRAGE}{magnetization prepared rapid gradient echo}
...
\newacronym[prefixfirst={a~},prefix={an\space}]{fod}{FOD}{fibre orientation distribution}
...
\newacronym[prefixfirst={a~},prefix={an\space}]{nhnn}{NHNN}{National Hospital for Neurology and Neurosurgery}
%% Definitions
