...
\newlength{\figwidth}\setlength{\figwidth}{\dimexpr \textwidth + \marginparwidth + \marginparsep\relax}

% The caption package adds more options for caption formatting.
% This set-up makes hanging labels, makes the caption text smaller
%  than the body text, and makes the label bold.
% Highly recommended.
\usepackage[format=plain,font=small,labelfont={bf,sf},labelsep=quad]{caption}
\usepackage[labelformat=simple]{subcaption}
\usepackage[outercaption,raggedright]{sidecap}
\sidecaptionvpos{figure}{t}
% \AtBeginEnvironment{SCfigure}{\captionsetup{format=plain}}
\captionsetup{margin={0pt,-\dimexpr\marginparwidth + \marginparsep},twoside}
\captionsetup[SCfigure]{margin={0pt,-\dimexpr\marginparwidth + \marginparsep},twoside}
...
\lstset{basicstyle=\ttfamily\small, basewidth=0.6em, keywordstyle=\bfseries, morekeywords={while,do,not}}
