...
Far more complex and controversial are decisions surrounding the surgical treatment of gliomas, those tumours originating in glial cells including astrocytes and oligodendrocytes which are among the most common malignant primary \gls{cns} neoplasms in both adults\autocite{Ostrom2015,Wanis2021} and children\autocite{Ostrom2015,Bauchet2009}.
...
Until recently, no clear consensus on how these categories should be defined existed, making comparison between past studies even more difficult\autocite{Karschnia2021}.
...
With the recent publication of new proposed volumetric resection categories in \textcite{Karschnia2021}, alongside evidence for improved prognostic value using this classification system \autocite{Karschnia2023}, the neurosurgical community will hopefully move towards more standardised reporting of tumour \gls{eor} in glioblastoma.
...
Furthermore, the categories defined in \textcite{Karschnia2021} are for glioblastoma resections only, while resection classification has yet to be standardised for many other tumour types, including medulloblastoma\autocite{Thompson2018}, one of the most common malignant childhood brain tumours.
...
As the developing brain of young children is especially sensitive to radiation-induced neurocognitive injury, the use of high-dose adjuvant radiotherapy may be deferred for as long as possible in paediatric patients to avoid subsequent life-long impairment\autocite{Padovani2012,Moxon-Emre2014}.
As such, the importance of \gls{eor} in children gains additional significance where residual unresected tumour cannot be neutralised with adjuvant radiotherapy.
...
Diffusion \gls{dmri} can be instrumental in differentiating these circumstances and assessing tract integrity\autocite{Field2004,Manan2023}.
Patterns of tract infiltration, displacement, and disruption can be described from the relative decreases and increases in \gls{fa} and \gls{adc}, together with changes in colour on \gls{dec} maps, as reviewed in \textcite{Manan2023}.
While \gls{dmri} can therefore reveal information about the tumour--\gls{wm} environment and inform surgical planning, it can also hinder accurate tract reconstruction, which often relies on expectations of normal diffusion patterns.
...
The fluorescence effect is particularly prominent in high-grade tumours, which are also often more difficult to distinguish from surrounding healthy tissue without the enhanced contrast provided by PPIX.
5-ALA guided surgery results in improved \gls{eor} and higher progression free survival in high-grade gliomas, while maintaining preservation of functional tissue\autocite{Coburger2019,Golub2020}, and has seen widespread adoption in the surgical treatment of gliomas\autocite{Stummer2006} and inclusion in UK national care guidelines\autocite{NICE2021}.
Not all tumour types, however, can be better resected under 5-ALA guidance.
In particular, strong evidence for the usefulness of 5-ALA in common paediatric tumours, including \glspl{lgg} and medulloblastomas, is lacking, as are rigorous trials confirming it is safe to use in children\autocite{Schwake2019}.
