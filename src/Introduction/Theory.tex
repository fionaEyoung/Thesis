...
\begin{figure}[h!]
  \begin{subfigure}[b]{0.5\textwidth}
    ...
    \caption{\citeauthor(Arnold1838) (\citeyear(Arnold1838)), Tabula VII, Fig. 1}\label{fig:ardnoldVII1}
  \end{subfigure}%
  \begin{subfigure}[b]{0.5\textwidth}
    \includesvg[width=\textwidth,pretex=\ttfamily\small]{chapter_1/arnold1838bd1_0046_TABX.svg}
    \caption{\citeauthor(Arnold1838) (\citeyear(Arnold1838)), Tabula X, Fig. 4}\label{fig:ardnoldX4}
  \end{subfigure}
