...
In this way, fibre tracts form fractal echos the of their individual neural members, drawing on many inputs to disseminate the output signals across countless targets.
...
\begin{figure}[bh!]
  \centering
  \includegraphics[width=0.6\textwidth]{xkcd_1163_debugger.png}
