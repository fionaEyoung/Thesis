...
At equilibrium, more spins magnetic moments will occupy the lower energy state aligned with $\mathbf{B}_0$, resulting in a net bulk magnetisation $\mathbf{M}_z$.
...
This dephasing is associated with the ``true" T2.
...
The combination of intrinsic T2 and the effects of field inhomogeneities produce an overall dephasing effect characterised by T2*, where  T2* $\leqslant$ T2.
...
The signal at echo peak is then only dependent on the intrinsic T2, not on T2*.
