...
A well cited example of this limitation can be seen in reconstructions of the \gls{cst}, known to emanate from the entire motor cortex from the apex down to the Sylvian fissure, but which \gls{dt}-based algorithms would have you believe is little more than a \note{stick}.
