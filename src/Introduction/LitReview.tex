...
Current understanding of neuroplasticity and brain tumours is limited to a small number of case studies, and more systematic research into the mechanisms and robust detection of functional reorganisation are required before these findings can be put into everyday clinical practice\autocite{Duffau2005,Abel2015,Satoer2017}.
Taken together with the emergence of the hodological framework for neurosurgery as discussed in section \ref{sec:hodology}\autocite{Sala2019}, improved study of neuroplasticity could gradually lead to wide applicability of total or supratotal resection without an associated elevated risk to neurological function and postoperative quality of life.
...
\Gls{fmri} and navigated transcranial magnetic stimulation \autocite{WeissLucas2020} map out cortical areas of functional importance that lie in proximity to the lesion, including the motor, language, and sensory cortices, providing functional complement to the purely structural data obtained from previously mentioned modalities.
In epilepsy cases, \gls{eeg} may be employed to monitor epileptogenic regions\autocite{Sarco2006}.

Alongside functional cortical mapping, \gls{dmri} is playing an ever-increasingly important role for surgical planning and navigation\autocite{Manan2022}.
...
Peri-tumoural oedema and invading cells can lead to drastically altered measured diffusion signals and reduction of anisotropy, complicating their interpretation and inhibiting accurate tracking\autocite{Bulakbas2009,Nimsky2010,Kuhnt2013}.
That said, \gls{dti} and streamline tractography have brought dramatic improvements to neurosurgical planning, unlocking detailed visualisations of \gls{wm} tracts and their spatial relationship to the surgical target and even acting as a predictor of postoperative deficits with implications for preoperative patient counselling\autocite{Manan2022}.
...
As a notable example, popular neuronavigation platform provider Brainlab's iPlan\textregistered{} (single tensor)\autocite{Brainlab2012} and Elements (dual tensor)\autocite{Sollmann2020a} Fibre Tracking applications (Brainlab AG, Munich, Germany) use a version of \gls{fact} \autocite{Mori1999}.
...
Functional monitoring with \gls{des} is a crucial component of neurosurgical workflows and widely considered the gold standard for localising neural function.
Electrical current is applied to the cortical surface at increasing strengths\autocite{Saito2015}, and where stimulation elicits in a functional response or disruption, the corresponding region is deemed eloquent.
Additionally, stimulation of subcortical white matter during resection can be used to indicate when resection should be halted as underlying eloquent structures are approached\autocite{Sala2019}.
...
Awake surgery is complex, psycho-cognitively and emotionally demanding of the patient, and not universally tolerated\autocite{Nossek2013a,Wang2019}.
...
5-ALA guided surgery results in improved \gls{eor} and higher progression free survival, while maintaining preservation of functional tissue\autocite{Coburger2019,Golub2020}, and has seen wide uptake in the surgical treatment of gliomas\autocite{Stummer2006}.
...
Intraoperative \gls{mri} is becoming an increasingly common and valued addition to neurosurgical set-ups.
This includes low field open bore systems which can be installed in the operating room, and allow for easy transfer of the patient into the scanner\autocite{Steinmeier1998,Senft2010}, as well as full high-field systems which acquire far higher quality images with potentially more clinical utility\autocite{Makary2011} at the expense of practicality, as interrupting surgery for an extended scan session and safely transferring a patient from the operating table to inside the bore of the scanner in an adjoining room is a substantial logistical and medical challenge\autocite{Senft2010,Giordano2016a,Sattur2019}.
Challenges notwithstanding, intraoperative \gls{mri} is incredibly valuable for determining surgical margins and providing guidance after the effects of brain shift deformations have invalidated preoperative imaging.

Numerous works demonstrate the effect of \gls{imri} in improving postsurgical outcomes in both tumour and epilepsy surgery, including greater \gls{eor}, fewer new postoperative deficits, greater postoperative seizure freedom, and reduced length of hospital stay in both adults and children
...
Even with advanced image and surgical guidance, postoperative \gls{mri} may show residual tumour nodules, concealed in corners of the resection cavity.
...
Not only does \gls{imri} allow immediate identification of any need for additional resection, even in cases where the \gls{imri} scan indicates complete resection, it can serve as the postoperative scan and replace the need to subject the patient to an additional scan after surgery with all the discomfort and possible sedation that would entail.
...
Cost effectiveness can be further increased with a dual use set-up, in which an \gls{imri} system is used both for intraoperative and routine diagnostic scanning\autocite{Giordano2016a}, as is the case at \gls{gosh} in London.
Further challenges of implementing \gls{imri} include longer operating times, equipment compatibility, and optimal patient positioning for both navigated surgery and scanning\autocite{Giordano2017}.
Worth noting that the strength of evidence supporting all \gls{imri} use and cost-effectiveness is still under debate \autocite{Jenkinson2018,Garzon-Muvdi2019,Caras2020}, and interpretation of \gls{imri} studies is fraught by selection bias and a lack of randomised control trials\autocite{Kubben2011}.
...
What has been less extensively studied is the potential for \gls{imri} to provide additional, post-brain shift advanced functional neuronavigation.
Broadly speaking, this could be approached in two ways.
The first is to use conventional \gls{imri} to dynamically adjust preoperative functional information (including \gls{fmri} and tractography) using deformable registration \note{defined?} and / or biomechanical brain shift modelling, the second is to directly acquire new advanced \gls{mri} sequences intraoperatively.
While the former may seem like the preferred choice, as one avoids having to acquire additional lengthy scans and further prolonging surgery interruption, achieving robust deformable registration in a reasonable timeframe is by no means trivial, and especially complicated given the significantly disturbed anatomy following craniotomy and complex brain shift, as we will see in Chapter \ref{chap:reg} \note{cite}.
Intraoperative \gls{fmri} has been reported in a very limited number of studies in \gls{dbs}\autocite{Hiss2015,Knight2015}, tumour resection\autocite{Roder2016a,Qiu2017a}, and neurovascular\autocite{Muscas2019} surgeries, but it's unlikely to find widespread use on account of practicality and a preference for \gls{des} for cortical mapping.
By contrast, intraoperative \gls{dmri} has several potential advantages.

Use of tractography for neuronavigation is valued by many, but it's accuracy diminishes with increasing brain shift, at the same time as the resection potentially approaches critical subcortical \gls{wm}\autocite{Yang2019}.\note{awkward sentence}
...
Secondly, intraoperative \gls{dmri} can suffer from degraded image quality\autocite{Roder2019}, and distortion artefacts common in \gls{dmri} sequences utilising \gls{epi} are exasperated by the tissue--air interface at the craniotomy site\autocite{Elliott2020}, which can significantly degrade the accuracy of \gls{wm} tract localisation\autocite{Yang2022}.
...
Nevertheless, concrete evidence of benefits to postoperative outcomes with intraoperative advanced \gls{dmri} is mounting\autocite{DAndrea2012,Cui2015,Maesawa2010}, and in combination with what we already know about conventional intraoperative \gls{mri} and preoperative imaging for \gls{wm} neuronavigation, it stands to reason that intraoperative \gls{dmri} could bring significant improvements to brain surgery if some of the technical and image processing limitations can be overcome.

All neuronavigational tools are complementary, providing distinct streams of information and where possible, combination of techniques can increase the chances of achieving and optimal outcome.
...
Reviews have found similar benefits to \gls{eor} from both \gls{imri} and 5-ALA guidance separately\autocite{Golub2020} \note{either or alone?} and even better outcomes when both are combined\autocite{Nickel2018,Coburger2019}.
...
Advanced functional mapping, presurgical planning, and intraoperative monitoring, where the appropriate resources and expertise are available\autocite{GeorgeZakiGhali2020}, increases operability of highly eloquent gliomas
