...
Depicting peak orientations is achieved through \gls{dec} mapping, in which directions are mapped to colours in RGB space, where the $x$-axis, or medio-lateral / left-right direction is assigned pure red, the $y$-axis, or posterior-anterior direction is assigned pure green, and the $z$-axis, or inferior-superior direction, is assigned pure blue.
...
\begin{figure}
  \centering
  \includesvg[width=0.6\textwidth,inkscapelatex=true,pretex=\small\sffamily]{chapter_2/fods.svg}
