...
\begin{SCfigure}[][htb!]
  ...
  \caption{Schematic reconstruction of the \glspl{or}, shown from an inferior axial viewpoint. Fibres originating in the \glsentrylong{lgn} of the thalamus arch anteriorly forming Meyer's loop, before returning towards the visual centres in the occipital cortex.}
  \label{fig:or}
\end{SCfigure}
