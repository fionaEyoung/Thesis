...
\begin{figure}
  ...
  \caption{Streamlines that I filtered \note{caption} \label{fig:filter}}
\end{figure}
...
Atlases have so far been created for the most commonly indicated pathways in neurosurgical planning and guidance, namely the \gls{cst}, \gls{af}, \gls{or} and \gls{ifof} (Fig. \ref{fig:atlases}), with the creation of further atlases to be the subject of future work.
...
\begin{figure*}[h!]
  \centering
  \makebox[\linewidth][c]{%
    \includegraphics[width=0.28\textwidth]{chapter_3/cst_tod.png}%
    \includegraphics[width=0.28\textwidth]{chapter_3/or_tod.png}%
    \includegraphics[width=0.28\textwidth]{chapter_3/af_tod.png}%
    \includegraphics[width=0.28\textwidth]{chapter_3/ifo_tod.png}}
  \caption{Tract orientation atlases, composite images in coronal (CST), axial (OR, IFOF) and sagittal (AF) views. All figures depicted in MNI152 reference space. \note{valign and bigger} \note{different caption / reprod. from \textcite{Young2024}}}\label{fig:atlases}
\end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
