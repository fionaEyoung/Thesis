...
To fulfil the aims laid out in Chapter \ref{chap:problem}, a framework loosely modelled on Bayesian statistics was initially proposed, in which the voxel-wise probability of identifying a tract in a given location is determined by neuroanatomically informed prior expectations and the \gls{dmri}-derived evidence supporting those expectations.
Some early explorations which formed the basis for the work covered in this chapter are described in \textcite{Young2020}.
The final method combines aspects of both traditional atlas-based and direct data-driven approaches to segmentation, and is named \textit{tractfinder}.
...
As a projection tract, the \glsreset{or}\gls[noindex=false]{or} is among the more easily definable in terms of its end points.
...
As it projects towards the most posterior reaches of the occipital lobe, the \gls{or} forms part of the \gls[noindex=false]{ss}, a confluence of fibres superficial to the lateral ventricle, comprising the antero-posteriorly oriented fibres of association and projection fibres of the occipital, temporal and frontal lobes\autocite{Maldonado2021}.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table*}[t]
  \caption[Streamline filtering statistics]{Total streamline counts (all atlas subjects combined) before and after bulk filtering. Abbreviations: \acrolist{af,crp,cc,cst,ec,slf,sfof,vof}}
  \label{tab:filt}
  \small
