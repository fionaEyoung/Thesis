...
In this example case of \pgls{nhnn} patient with a tumour embedded within the right precentral gyrus (tumour histology information is unavailable for this subject) we will consider the combination of tumour mass effect and peritumoural oedema on tract reconstruction.
...
\begin{figure}[htb!]
  ...
  \caption[GOSH iMRI patient 8, preoperative imaging]{Preoperative $T_1$-weighted imaging (top) of patient 8 with high-grade left thalamic glioma. Bottom: Tumour deformation modelling in a co-registered MNI template image. No \gls{dmri} acquired preoperatively was available.}
  \label{fig:8p}
\end{figure}
...
\begin{figure}
  ...
  \caption[GOSH iMRI patient 8, intraoperative imaging]{Intraoperative imaging showing transcallosal approach to patient 8's thalamic glioma. Top: $T_1$-weighted imaging. Bottom: \gls{dti} \gls{dec} \gls{fa} map. Arrowheads indicate partially infiltrated and displaced internal capsule.}
  \label{fig:8i}
\end{figure}
...
\begin{figure}
  ...
  \textbf{\sffamily a.} \Gls{dt}.
  \textbf{\sffamily b.} \Gls{csd} \glspl{fod} (\gls{msmt} \gls{csd} with \gls{wm} and \gls{csf} compartments).
  \textbf{\sffamily c.} Deformed \gls{tod} \gls{cst} atlas. While the main body of the tract is well defined in all three images, the boundaries between intact fibres, infiltrated \gls{wm}, and tumour are indiscernible.}
  \label{fig:8i_fod}
\end{figure}
...
\begin{figure}
  ...
  \caption[GOSH iMRI patient 8, intraoperative imaging, corticospinal tract reconstructions]{Coronal slices in 5~mm increments with \gls{cst} reconstructions on intraoperative imaging for patient 8. Top: Probabilistic streamline tractography, Bottom: Tractfinder \gls{cst} with tumour deformation modelling based on preoperative tumour segmentation.}
  \label{fig:8i_tf}
\end{figure}
...
\begin{figure}[htb!]
  ...
  \caption[GOSH iMRI patient 5, preoperative imaging]{Preoperative radiological presentation of \gls{gosh} patient 5, with a low-grade astrocytoma of the left thalamus. Top: $T_1$-weighted scan. Bottom: \gls{dti} \gls{dec} \gls{fa} map. Arrowheads indicate the \gls{cst}, partially located within the tumour.}
  \label{fig:5p}
\end{figure}
...
\begin{figure}[htb!]
  ...
  \caption[GOSH iMRI patient 5, preoperative imaging, corticospinal tract reconstruction]{Reconstruction of the left \gls{cst} on preoperative imaging for patient 5. Top: Streamline tractography \gls{tdi} map, thresholded at ten streamlines. Bottom: Tractfinder with and without deformation modelling merged into a single segmentation.}
  \label{fig:5p_cst}
\end{figure}
...
\begin{figure}[htb!]
  ...
  \caption[GOSH iMRI patient 5, intraoperative imaging]{Intraoperative $T_1$-weighted (top) and \gls{dec} \gls{fa} (bottom) for patient 5, showing left craniotomy and surgical corridor through the temporal lobe}
  \label{fig:5i}
\end{figure}
...
\begin{figure}[htb!]
  ...
  \caption[GOSH iMRI patient 5, intraoperative imaging, corticospinal tract reconstruction]{Reconstruction of the \gls{cst} on intraoperative imaging using tractography (top) and tractfinder (bottom) with standard affine registration.}
  \label{fig:5i_cst}
\end{figure}
