...
\begin{figure}
  ...
  \caption{Adult patient with a tumour in the right precentral gyrus.
...
\begin{figure}[htb!]
  ...
  \caption{Reconstruction of the left \gls{cst} on preoperative imaging for patient 5. Top: Streamline tractography \gls{tdi} map, thresholded at ten streamlines. Bottom: Tractfinder with and without deformation modelling merged into a single segmentation.}
  \label{fig:5p_cst}
\end{figure}
