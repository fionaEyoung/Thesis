...
\begin{SCfigure}
  ...
  \caption[Signed bundle distances to streamline tractography, HCP dataset]{Signed bundle distances for all methods compared against targeted tractography in the \gls{hcp} dataset. \acrolist{af, cst, or, ifof, tf, at, tsx, tsd}}
  \label{fig:hcpbox}
\end{SCfigure}
