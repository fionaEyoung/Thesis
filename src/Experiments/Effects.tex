...
\begin{figure}[h!]
  ...
  \caption{Baseline \gls{ssepi} diffusion sequence and three \gls{rsepi} test sequences. From top: Baseline (30\x b1000 \gls{ssepi} \gls{dti}), 7seg 6\x b800, 3seg 12\x b1000, 3seg 20\x b1000}
  \label{fig:rsepi}
\end{figure}
...
\begin{figure}[h!]
  ...
  \end{subfigure}
  \caption{\glspl{fod} at the centrum semiovale and full \gls{cst} tractography streamlines. From left to right, top to bottom: Baseline (30\x{}b1000 \gls{ssepi} \gls{dti}), 7seg 6\x{}b800, 3seg 12\x{}b1000, 3seg 20\x{}b1000}
  \label{fig:rsepi-fod}
\end{figure}
