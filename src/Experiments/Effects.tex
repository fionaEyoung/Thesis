...
A search on the online publication database Web of Science for \verb|(few OR single OR one) AND shot AND learning|, (excluding results about singl-shot echo planar imaging) revealed a sharply increasing trend in the broad field of medical imaging alone \note{as in, broadly defined} (Fig. \ref{fig:pubs}).
